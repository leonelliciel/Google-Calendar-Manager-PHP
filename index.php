...
<nav class="navbar navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <span class="navbar-brand text-uppercase" >Google Calendar Manager</span>
        </div>
    </div>
</nav>
...
;                ?>
                ...
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item">Editer un evenement</a>
                    <a href="#" class="list-group-item">Supprimer un &eacute;vènement</a>
                </div>
            <?php }
            ?>
